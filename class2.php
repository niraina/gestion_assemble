...
<table id="dtBasicExample" class="table table-striped table-bordered" cellspacing="0" width="100%">
  ...
  <tbody>
   ...
   <tr>
                            ...
                            <td><?php echo $row['classeD']; ?></td>
                            <td><?php echo $row['dateDc']; ?></td>
                            <td><?php echo $row['DcEchelonU']; ?></td>
                            <td><?php echo $row['dateDcEchelonU']; ?></td>
                            ...
                            <td>
                                ...
                                <a href="reload2.php?id_av=<?php echo $row['id_av']; ?>" class="btn btn-info"  role="button"><i class="glyphicon glyphicon-plus"></i></a>
