...
<table id="dtBasicExample" class="table table-striped table-bordered" cellspacing="0" width="100%">
  ...
  <tbody>
   ...
   <tr>
                            ...
                            <td><?php echo $row['classeE']; ?></td>
                            <td><?php echo $row['dateCe']; ?></td>
                            <td><?php echo $row['CeEchelonU']; ?></td>
                            <td><?php echo $row['dateCeEchelonU']; ?></td>
                            ...
                            <td>
                                ...
                                <a href="reloadE.php?id_av=<?php echo $row['id_av']; ?>" class="btn btn-info"  role="button"><i class="glyphicon glyphicon-plus"></i></a>
