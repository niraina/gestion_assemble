...
<table id="dtBasicExample" class="table table-striped table-bordered" cellspacing="0" width="100%">
  <thead class="thead-dark">
    <tr>
      ...
      <th class="th-sm">Avancement en classe
      ...
      <th class="th-sm">Avancement en echelon
  ...
  <tbody>
   ...
   <tr>
                            ...
                            <td><?php echo $row['classeP']; ?></td>
                            <td><?php echo $row['dateCp']; ?></td>
                            <td><?php echo $row['CpEchelonU']; ?></td>
                            <td><?php echo $row['dateCpEchelonU']; ?></td>
                            ...
                            <td>
                                ...
                                <a href="reloadP.php?id_av=<?php echo $row['id_av']; ?>" class="btn btn-info"  role="button"><i class="glyphicon glyphicon-plus"></i></a>
