...
<form id="wizardForm" method="post" action="up2.php" class="form-horizontal wizardForm">
                    ...
                    <fieldset class="step" id="first">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <input type="date" name="dateDc" id="dateDc" class="form-control" value="<?php echo $row['dateDc']; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <input type="date" name="dateDcEchelonU" id="dateDcEchelonU " class="form-control" value="<?php echo $row['dateDcEchelonU']; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="dateE" class="control-label col-lg-4">Avancement en echelon</label>
                            ...
                            <div class="col-lg-8">
                                <input type="text" name="DcEchelonD" id="DcEchelonD " class="form-control" value="<?php echo $row['DcEchelonD']; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="dateE" class="control-label col-lg-4">Date d'avancement en echelon</label>
                            ...
                            <div class="col-lg-8">
                                <input type="date" name="dateDcEchelonD" id="dateDcEchelonD " class="form-control" value="<?php echo $row['dateDcEchelonD']; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="dateE" class="control-label col-lg-4">Avancement en echelon</label>
                            ...
                            <div class="col-lg-8">
                                <input type="text" name="DcEchelonT" id="DcEchelonT " class="form-control" value="<?php echo $row['DcEchelonT']; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="dateE" class="control-label col-lg-4">Date d'avancement en echelon</label>
                            ...
                            <div class="col-lg-8">
                                <input type="date" name="dateDcEchelonT" id="dateDcEchelonT" class="form-control" value="<?php echo $row['dateDcEchelonT']; ?>" >
                            </div>
                        </div>
                        <div class="form-group">
