...
?>
                        ...
                        ?>
<form id="wizardForm" method="post" action="upP.php" class="form-horizontal wizardForm">
                    ...
                    <fieldset class="step" id="first">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <input type="text" name="classeP" id="classeP" class="form-control" value="Classe principale">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <input type="date" name="dateCp" id="dateCp" class="form-control" value="<?php echo $row['dateCp']; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <input type="text" name="CpEchelonU" id="CpEchelonU" class="form-control" value="1 ere echelon">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <input type="date" name="dateCpEchelonU" id="dateCpEchelonU " class="form-control" value="<?php echo $row['dateCpEchelonU']; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="dateE" class="control-label col-lg-4">Avancement en echelon</label>
                            ...
                            <div class="col-lg-8">
                                <input type="text" name="CpEchelonD" id="CpEchelonD " class="form-control" value="<?php echo $row['CpEchelonD']; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="dateE" class="control-label col-lg-4">Date d'avancement en echelon</label>
                            ...
                            <div class="col-lg-8">
                                <input type="date" name="dateCpEchelonD" id="dateCpEchelonD " class="form-control" value="<?php echo $row['dateCpEchelonD']; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="dateE" class="control-label col-lg-4">Avancement en echelon</label>
                            ...
                            <div class="col-lg-8">
                                <input type="text" name="CpEchelonT" id="CpEchelonT " class="form-control" value="<?php echo $row['CpEchelonT']; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="dateE" class="control-label col-lg-4">Date d'avancement en echelon</label>
                            ...
                            <div class="col-lg-8">
                                <input type="date" name="dateCpEchelonT" id="dateCpEchelonT" class="form-control" value="<?php echo $row['dateCpEchelonT']; ?>" >
                            </div>
                        </div>
                        <div class="form-group">
