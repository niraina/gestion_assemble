...
<table id="dtBasicExample" class="table table-striped table-bordered" cellspacing="0" width="100%">
  ...
  <tbody>
   ...
   <tr>
                            ...
                            <td><?php echo $row['classeU']; ?></td>
                            <td><?php echo $row['datePc']; ?></td>
                            <td><?php echo $row['PcEchelonU']; ?></td>
                            <td><?php echo $row['datePcEchelonU']; ?></td>
                            ...
                            <td>
                                ...
                                <a href="reload1.php?id_av=<?php echo $row['id_av']; ?>" class="btn btn-info"  role="button"><i class="glyphicon glyphicon-plus"></i></a>
