...
?>
                        ...
                        ?>
<form id="wizardForm" method="post" action="upE.php" class="form-horizontal wizardForm">
                    ...
                    <fieldset class="step" id="first">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <input type="text" name="classeE" id="classeE" class="form-control" value="Classe exceptionnelle">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <input type="date" name="dateCe" id="dateCe" class="form-control" value="<?php echo $row['dateCe']; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <input type="text" name="CeEchelonU" id="CeEchelonU" class="form-control" value="1 ere echelon">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <input type="date" name="dateCeEchelonU" id="dateCeEchelonU " class="form-control" value="<?php echo $row['dateCeEchelonU']; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="dateE" class="control-label col-lg-4">Avancement en echelon</label>
                            ...
                            <div class="col-lg-8">
                                <input type="text" name="CeEchelonD" id="CeEchelonD " class="form-control" value="<?php echo $row['CeEchelonD']; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="dateE" class="control-label col-lg-4">Date d'avancement en echelon</label>
                            ...
                            <div class="col-lg-8">
                                <input type="date" name="dateCeEchelonD" id="dateCeEchelonD " class="form-control" value="<?php echo $row['dateCeEchelonD']; ?>">
                            </div>
                        </div>
